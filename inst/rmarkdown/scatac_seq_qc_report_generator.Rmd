---
title: "scATAC Sequencing Batch Summary: `r {params$in_sample}`"
...
```{r atac_child, child =  system.file("rmarkdown/scatac_seq_module.Rmd", package = "scATAC_Seq_Pipeline"), eval =  has_atac}

...
if(is.null(params$in_post)) {
  in_post <- system.file("testdata/postprocessed", package = "scATAC_Seq_Pipeline")
  in_frag <- system.file("testdata/outs/fragments.tsv.gz", package = "scATAC_Seq_Pipeline")
  in_meta <- system.file("testdata/batch_qc/X055_X055-AP0C1W1_filtered_metadata.csv.gz", package = "scATAC_Seq_Pipeline")
  genome <- "hg38"
  refs <- "all"
  window_sizes <- "all"
  out_dir <- tempdir()
